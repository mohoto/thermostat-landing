      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 2xl:grid-cols-7 2xl:gap-x-32 gap-y-12 lg:gap-y-0 lg:place-content-between lg:place-items-center">
            <div className="lg:col-span-1 2xl:col-span-4 order-2 lg:order-1">
                <h1 className="2xl:text-4xl font-bold mb-12 lg:text-3xl text-3xl">Profitez de thermostats connectés gratuits et <span className="text-liia-orange">réduisez vos factures de chauffage !</span></h1>
                ...
                <p className="mb-12 text-lg font-light lg:first-line:w-10/12"><span className="font-semibold bg-[#ffed00] py-1 px-2 rounded-lg">Disponible jusqu’au 31 décembre 2024</span></p>
