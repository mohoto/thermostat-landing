  ...
  return (
    <section className="pb-8 pt-2">
        <div className="container">
            <div className="grid lg:grid-cols-2 lg:gap-x-32 lg:items-end gap-y-10 lg:gap-y-0">
                <div>
                    <Image
                    src="/images/liia-energies-thermostat-connecte-2.png"
                ...
                <div>
                    <h2 className="2xl:text-3xl font-bold mb-8 text-2xl">Pourquoi s’équiper de thermostats connectés ?</h2>
